...
<div class="chap">
  ...
  <div class="example">
    ...
    <li>
      https://github.com/mvolkmann/svelte-and-sapper-in-action/tree/master/svelte-shop-manual-routing
    </li>
    <li>
      https://github.com/mvolkmann/svelte-and-sapper-in-action/tree/master/svelte-shop-hash-routing
    </li>
    <li>
